...
function agregarPropiedad (objeto, property) {
  // Agrega property a objeto (argumento "objeto") con el valor `null`
  // Devuelve el objeto
...
function pasarUsuarioAPremium (usuarios) {
  ...
  //(me parece quese refiere a que hay una cantidad indetermianda de objetos 'usuario')
